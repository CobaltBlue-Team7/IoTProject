...
public class MainActivity extends Activity implements View.OnClickListener {
    public static String bin_status;
    public static String bin_loc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  findViewById(id.animation).setOnClickListener(this);
       ...
       // findViewById(id.configuration).setOnClickListener(this);
        ...
        try{
            bin_status = new GetStatus().execute().get();
            bin_loc = new GetLocation().execute().get();

            // do JSON result parsing
            Log.w("Status", bin_status);
            Log.w("Loc", bin_loc);
